...
HELP_TEXT = (
    ...
    "2) If it looks good: /confirm\n"
    "3) If it needs edits: /fixscore or /fixname (or re-upload a clearer photo)\n\n"
    "Commands:\n"
    ...
    "- /fixscore <P#> <G#> <value> — fix a score in your pending CSV\n"
    "- /fixname <P#> <new name> — fix a player name in your pending CSV\n"
    "- /help — show this help\n\n"
    "Notes:\n"
    "- Your CSV includes player numbers P1..P6. Use those in /fixscore and /fixname.\n"
